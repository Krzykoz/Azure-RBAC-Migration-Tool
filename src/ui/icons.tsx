...
/**
 * Inline stroke-icon set (Lucide-style paths). Each icon accepts a `className`
 * for sizing/coloring via Tailwind.
 */
...
export const KeyVaultIcon = icon(
  <>
...
export const CompoundIdentityIcon = icon(
  <>
