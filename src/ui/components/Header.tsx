  ...
  return (
    <header className="bg-neutral-800 text-white h-12 flex items-center justify-between px-3 sm:px-4 sticky top-0 z-50 shadow-md">
      <div className="flex min-w-0 items-center gap-2 sm:gap-4">
        <span className="whitespace-nowrap font-semibold text-sm tracking-tight sm:text-base">Key Vault Migrator</span>
        <div className="hidden h-4 w-px bg-neutral-600 mx-1 sm:block"></div>
        <h1 className="hidden text-sm font-normal text-neutral-300 sm:block">
          RBAC Assistant
        </h1>
      </div>
      ...
      <div className="flex shrink-0 items-center gap-2 sm:gap-4">
        ...
        {user && (
          <div className="flex items-center gap-2 pl-2 border-l border-neutral-700 sm:gap-4">
