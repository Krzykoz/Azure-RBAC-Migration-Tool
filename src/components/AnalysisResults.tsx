                                            ...
                                            {res.existingCoverage && res.existingCoverage.isFullyCovered ? (
                                                <>
                                                    <div className="p-2 bg-green-50 dark:bg-green-900/20 border border-green-100 dark:border-green-800 rounded text-xs mb-2">
                                                        ...
                                                        <button
                                                            onClick={() => toggleCoverageDetails(res.originalPolicy.objectId)}
                                                    ...
                                                    <button
                                                        onClick={() => toggleSuggestion(res.originalPolicy.objectId)}
                                                    ...
                                                    >
                                                        {showSuggestions[res.originalPolicy.objectId] ? 'Hide Suggested Roles' : 'Show Suggested Roles'}
                                                    </button>
                                                </>
                                            ) : (
                                                <>
                                                    {res.existingCoverage && res.existingCoverage.roleMatches.length > 0 && (
